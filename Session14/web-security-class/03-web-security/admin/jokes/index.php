...
include_once $_SERVER['DOCUMENT_ROOT'] .
		'/web-security-class/03-web-security/includes/magicquotes.inc.php';

require_once $_SERVER['DOCUMENT_ROOT'] . '/web-security-class/03-web-security/includes/access.inc.php';
...
if (isset($_GET['add']))
{
  ...
  include $_SERVER['DOCUMENT_ROOT'] . '/web-security-class/03-web-security/includes/db.inc.php';
