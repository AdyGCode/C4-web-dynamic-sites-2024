...
include_once $_SERVER['DOCUMENT_ROOT'] .
    'php/week12/includes/magicquotes.inc.php';

require_once $_SERVER['DOCUMENT_ROOT'] . 'php/week12/includes/access.inc.php';
...
if (isset($_GET['addform']))
{
  ...
  include $_SERVER['DOCUMENT_ROOT'] . 'php/week12/includes/db.inc.php';
