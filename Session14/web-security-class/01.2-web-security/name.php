    ...
    <div class="outer">
        ...
        <div class="contentarea">
            ...
            <div class="column1">
                ...
                <p class="text02">Use this site to test the login process for your Xampp server.
                    <p class="text02"><a href="sec-area/">Login</a> htaccess</p>
                ...
                <ul id="icons01" class="icons">
                    ...
                    <li>
                        <a class="n02" href="https://jsfiddle.net/">
																					<svg>
																						<use xlink:href="#icon-929"></use>
																					</svg>
																					<span class="label">JSFiddle</span>
																				</a>
                    </li>
                    <li>
                        <a class="n03" href="https://github.com">
																					<svg>
                    ...
                    <li>
                        <a class="n04" href="https://instagram.com">
																					<svg>
                    ...
                    <li>
                        <a class="n05" href="mailto:id@nmtafe.wa.edu.au">
																					<svg>
            ...
            <div class="column2">
                <h2>The Form Capture</h2>
                <?php
					$firstName = $_REQUEST['firstname'];
					$password = $_REQUEST['password'];
					
					if ($firstName == 'Tony' and $password == 'Evans'){
						echo '<p class="text02">Welcome, Lecturer - '. htmlspecialchars($firstName, ENT_QUOTES, 'UTF-8') . ', You are now logged in !</p>';
					}else{
						echo '<p class="text02">Welcome to our website - ' .
						htmlspecialchars($firstName, ENT_QUOTES, 'UTF-8') .'!</p>';
					}
				?>
