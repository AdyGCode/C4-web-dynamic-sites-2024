...
<html lang="en">
  ...
  <body>
    ...
    </form><script src='https://www.paypalobjects.com/js/external/connect/api.js'></script>
<span id='cwppButton'></span>
<script src='https://www.paypalobjects.com/js/external/connect/api.js'></script>
<script>
paypal.use( ['login'], function (login) {
  login.render ({
    "appid":"Ad2HX45-MfZndOswd8hBjlQFz5jV0vVpnhrS_15RsfV_-az4f_EY0zdlN782ZoJRxg-KoSEr_dYSHrhN",
    "scopes":"openid",
